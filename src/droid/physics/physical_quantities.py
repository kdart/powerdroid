...
# Modified by Keith Dart <dart@google.com>:
#   Modernized Python
#   Use numberdict
#   Added binary units (and removed "barns" unit)
#   Extended PhysicalUnit to allow easier casting
...
from droid.physics import numberdict
  ...
  def __init__(self, value, unit=None):
    if unit is not None:
      ...
      if type(value) is str:
        ...
        self.unit = _findUnit(value[len(match.group(0)):]) # TODO(dart) improve
      else:
